...
class SiteSetting extends Model
{
    ...
    protected $casts = [
        ...
        'order_source_retention_days' => 'integer',
        'order_delivery_retention_days' => 'integer',
        'vendor_document_download_allowed' => 'boolean',
        'platform_fee_percent' => 'decimal:2',
        'platform_fee_fixed' => 'decimal:2',
        'paytabs_enabled' => 'boolean',
        'paytabs_test_mode' => 'boolean',
        'paytabs_server_key' => 'encrypted',
        'paytabs_client_key' => 'encrypted',
        'tap_enabled' => 'boolean',
        'tap_test_mode' => 'boolean',
        'tap_secret_key' => 'encrypted',
        'tap_public_key' => 'encrypted',
        'noon_enabled' => 'boolean',
        'noon_test_mode' => 'boolean',
        'noon_app_key' => 'encrypted',
        'noon_app_secret' => 'encrypted',
        'amazon_ps_enabled' => 'boolean',
        'amazon_ps_test_mode' => 'boolean',
        'amazon_ps_access_code' => 'encrypted',
        'amazon_ps_sha_request' => 'encrypted',
        'amazon_ps_sha_response' => 'encrypted',
    ];
